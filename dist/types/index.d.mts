import { D as DecryptMiddlewareOptions, E as EncryptResponseOptions } from './index-BDRQyprS.mjs';
 ...
 */
declare function loadBePrivateKey(rawKeyEnv: string): void;
 ...
 */
declare function decryptRequest(
 ...
 */
declare function decryptWebRequestPayload(options?: DecryptMiddlewareOptions): RequestHandler;
 ...
 */
declare function encryptResponsePayload(
  payload:     unknown,
  fePublicKey: string,
  hmacKeyB64:  string,
...
export { DecryptMiddlewareOptions, type DecryptedPayload, EncryptResponseOptions, decryptRequest, decryptWebRequestPayload, encryptResponsePayload, loadBePrivateKey };
